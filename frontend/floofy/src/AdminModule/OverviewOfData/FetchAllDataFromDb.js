...
const fetchActiveUsersData = async (timeFrame) => {
  const fetchedActiveUsers = await fetch("base_api/api/countNewUsers", {
    method: "POST",
    headers: {
...
const fetchProductSalesData = async (timeFrame) => {
  const fetchedProductSales = await fetch("base_api/api/countProductSales", {
    method: "POST",
    headers: {
      "Content-Type": "application/json",
    },
...
const calculateRevenueData = async (timeFrame) => {
  const fetchTotalRevenue = await fetch(
    "base_api/api/calculateRevenueGenerated",
    {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
