...
function MyPostCard() {
      ...
      return (
                                    posts.map((post, index) => {
                                          return <Card className='border border-2 shadow-sm  bg-body-tertiary rounded container' style={{ width: '40%', height: "50%", margin: "1.4rem" }} key={index} >
                                                <Card.Body>
                                                ...
                                                <img src={DogImage} alt="" className='w-100' style={{ height: "200px"}} />
